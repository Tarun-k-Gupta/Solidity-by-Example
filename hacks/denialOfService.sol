...
What happened?
Attack became the king. All the new transactions to claim the throne will be rejected
since Attack contract does not have a fallback function, we are denying to accept the
...
//Prevention: Allow the users to withdraw their Ether instead of sending it.
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;
